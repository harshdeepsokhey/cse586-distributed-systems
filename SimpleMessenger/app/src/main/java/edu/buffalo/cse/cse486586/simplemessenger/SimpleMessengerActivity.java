    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /* Log.i(TAG, "Client/Socket Created ["+socket.getPort()+"]"); */
                ...
                /* 2. Push the message to the output stream */
                out.println(msgToSend);
                /* Log.i(TAG, "Client/message : "+msgToSend); */

                /* @CHECK : if socket needs to be closed : probably NO! */
                /* @CHECK : try using the ACK approach to ensure:
                *         a. that stream is not closed before message delivery
                *          b. that socket is not closed before message delivery
                */
